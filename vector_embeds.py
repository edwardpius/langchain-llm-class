...
# k=3 is the number of documents returned related to the query!
...
# text3 = "Physics is not one of my favourite subjects"
...
## Finding similarity between embed1 an embed2
# import numpy as np
