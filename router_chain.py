...
# Test
# response = chain.run("I need to go to Sri Lanka for vacation, a family of four. Can you help me plan this trip?")
response = chain.run("How old are the stars?")
# response = chain.run("What is computer science?") <-- Generic (default)
print(response)
